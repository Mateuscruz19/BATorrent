...
<p align="center">
  <img src="src/images/themes.gif" alt="Переключение между встроенными темами" width="820">
</p>

<p align="center">
  <img src="src/images/image2.png" alt="Светлая тема" width="420">
  <img src="src/images/image4.png" alt="Настройки" width="420">
</p>
...
| 🔎 **Найти и добавить** | Встроенный поиск (вкл. открытые источники СНГ/RuTor, без логина), Умная вставка (magnet / `thunder://` / hash по Ctrl+V), авто-загрузка по RSS с regex-фильтрами, drag-and-drop |
